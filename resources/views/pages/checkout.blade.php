                ...
                <div class="row">
                    <div class="col-lg-8 pl-lg-0">
                        ...
                        <div class="member mt-3">
                            ...
                            <p class="disclaimer mb-0">
                                You are only able to invite member that has registered in GoJapan.
                            </p>
                        </div>
                </div>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <div class="join-container">
                            <a href="{{ route('checkout-success', $item->id) }}" class="btn btn-block btn-join-trip mt-3 py-2">
                                I Have Made Payment
                            </a>
                        </div>
